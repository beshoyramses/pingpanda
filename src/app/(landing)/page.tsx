...
const page = () => {
  ...
  return (
    <>
      <section className="relative py-24 sm:py-32 pg-brand-25">
          ...
          <div className="relative mx-auto text-center flex flex-col items-center gap-10">
            <div>
              <Heading>
                ...
                <br />
                <span className="relative bg-gradient-to-r from-brand-700 to-brand-900 text-transparent bg-clip-text">
            ...
            <p className="text-base/7 text-gray-600 max-w-prose text-center text-pretty">
              ...
              Send Directory to yout Discord
            </p>
